import { chitProPlans } from "../pages/data/chitProPlans";
import React from "react";
import { Share2 } from "lucide-react";

export default function ChitProCards() {
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {chitProPlans.map((plan) => (
                ...
                >
                    ...
                    <div className="bg-blue-400 text-white text-center py-4 font-bold">
                        CHIT PRO
                    </div>
